        ...
        <div class="right-section">
            <div class="right">
                    ...
                    <h2>Category Manager</h2>
                       ...
                       <p>  This section displys the list of Categories</p><hr size="1"/>

                    <div class="link1">
                       <a href="pageadd.blade.php" >Click here</a> to create <a href="pageadd.blade.php">New Category</a><br/>
                    </div>
                    ...
                    <div class="displaypage">
                       ...
                       <table width=100%   border=1px solid black>
                         ...
                         <tr>
                            ...
                            <td><a href="{{'c_delete_data/'.$row->id}}" >Delete</a></td>
                         </tr>
                        @endforeach
